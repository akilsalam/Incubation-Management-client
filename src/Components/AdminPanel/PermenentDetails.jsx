...
const PermenentDetails = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch(`http://localhost:3000/admin/permenentDetail/${userId}`);
          if (response.ok) {
    ...
    <div className="d-flex justify-content-center align-items-center vh-100">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="small font-italic  mb-4 text-muted">
                    <p>You: {name}</p>
                    <p>Email: {email}</p>
                    <p>Phone No: {phone}</p>
                    <p>Address: {address}</p>
...
export default PermenentDetails;
